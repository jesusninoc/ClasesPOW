...
| :--- | :--- | :--- |
| **SEM (Search Engine Marketing)** | Proporciona resultados **inmediatos** a través de la publicidad (Google Ads). El SEO utiliza los datos de SEM (qué anuncios convierten mejor) para validar *keywords*. | Táctico (Corto Plazo) |
| **Marketing de Contenidos** | El **Contenido** es el vehículo del SEO. Una buena estrategia de contenidos garantiza que siempre haya material optimizado para satisfacer la **Intención de Búsqueda** del usuario. | Fundacional (Largo Plazo) |
| **Email Marketing** | Ayuda a la **retención** y al *engagement* de la audiencia ganada orgánicamente, creando señales de calidad indirectas para el motor de búsqueda. | Táctico y de Retención |
| **Redes Sociales (Social Media)** | Amplifican la visibilidad de los contenidos que ya están optimizados para SEO. Aunque los enlaces de redes sociales suelen ser **`nofollow`**, generan tráfico y **menciones de marca** (*Brand Mentions*), señales de autoridad valiosas. | Amplificación y Autoridad |
...
* **Tasa de Conversión Orgánica:** Porcentaje de visitas orgánicas que completan un objetivo (p. ej., una compra, una suscripción o una descarga).
* **Valor del Lead Orgánico:** Determinar el ingreso promedio generado por un cliente que se origina a través del canal orgánico.
* **Tasas de Rebote y Tiempo de Permanencia:** Indicadores de **calidad y *engagement***. Un bajo rebote y un alto tiempo de permanencia indican que el contenido satisface la intención de búsqueda, lo que es un fuerte factor positivo de *ranking*.
